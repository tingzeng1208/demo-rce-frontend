...
export const Calendar = ({
  ...
  return (
    ...
    // Ignoring because this element does not have a role in the USWDS implementation (https://github.com/uswds/uswds/blob/develop/src/js/Components/Form/date-picker.js#L1042)
